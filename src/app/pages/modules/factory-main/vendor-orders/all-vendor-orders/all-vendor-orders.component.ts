...
@Component({
  selector: 'app-all-vendor-orders',
  templateUrl: './all-vendor-orders.component.html',
  styleUrls: ['./all-vendor-orders.component.scss']
})
export class AllVendorOrdersComponent {
