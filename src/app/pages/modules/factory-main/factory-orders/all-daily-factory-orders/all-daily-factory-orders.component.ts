...
@Component({
  selector: 'app-all-daily-factory-orders',
  templateUrl: './all-daily-factory-orders.component.html',
  styleUrls: ['./all-daily-factory-orders.component.scss']
})
export class AllDailyFactoryOrdersComponent {
  ...
  tableColumns = ['order_code', 'order_date'];
  filterText = "";
  sortDirection = "";
  sortColumn = "";
  currentPage = 0;
  ...
  viewOrder(orderDate: any){
    // console.log(orderId);

    sessionStorage.setItem("factory_order_date", orderDate);
    this.router.navigateByUrl("/modules/factory-main/factory-orders/view-daily-factory-order");
  }
