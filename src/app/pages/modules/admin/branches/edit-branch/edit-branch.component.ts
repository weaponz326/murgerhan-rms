...
export class EditBranchComponent {
  ...
  updateBranch() {
    ...
    let data: Branch = {
      ...
      manager: {
        staff_id: this.branchData.data().manager.staff_id,
        full_name: this.branchData.data().manager.full_name
      },
  ...
  deleteBranch() {
    ...
    //   .then((res) => {
    //     console.log(res);
    //     this.router.navigateByUrl('modules/admin/branches/all-brnaches')
  ...
  setBranchData(){
    ...
    this.branchForm.controls.manager.setValue(this.branchData.data().manager.full_name);
